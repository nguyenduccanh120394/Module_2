...
public class Menu {
    ...
    public void menuInputFilm(){
        String leftAlignFormat = "| %-18s |%n";
        System.out.format("+--------------------+%n");
        System.out.format(leftAlignFormat,"Add to Film List:");
        System.out.format("+--------------------+%n");
    }
    ...
    public void menuInputStaff(){
        String leftAlignFormat = "| %-18s |%n";
        System.out.format("+--------------------+%n");
        System.out.format(leftAlignFormat,"Add to Staff List:");
        System.out.format("+--------------------+%n");
    }
    ...
    public void menuStafflist(){
        ...
        for (int i = 0; i < listStaffCNRoom.size(); i++) {
            System.out.format(leftAlignFormat,"ID Staff: "+listStaffCNRoom.get(i).getId()+" --->"+" Staff Name: "+ listStaffCNRoom.get(i).getName()+"--->"+" Mission: "+listStaffCNRoom.get(i).getMission());
        }
        System.out.format("+--------------------------------------------------------------------------+%n");
    }
